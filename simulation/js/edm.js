...
$(document).ready(function(){
	...
	$("#state").change(function(){
                  if(!isNaN($("#state").val())){
						...
						switch(x){
							case 1:
									$("#result1").html("<BR><small>Trail : 1 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 4.36 <BR> T<sub>on</sub> (&#956;s) : 0.25 <BR> T<sub>off</sub> (&#956;s) : 128</small>");
									
							break;
							case 2:
									$("#result1").html("<BR><small>Trail: 2 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 3.64 <BR> T<sub>on</sub> (&#956;s) : 0.3777 <BR> T<sub>off</sub> (&#956;s) : 128</small>");
									
							break;
							case 3:
									$("#result1").html("<BR><small>Trail : 3 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 3.6 <BR> T<sub>on</sub> (&#956;s) : 0.505 <BR> T<sub>off</sub> (&#956;s) : 128</small>");
									
							break;
							case 4:
									$("#result1").html("<BR><small>Trail : 4 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 3.33 <BR> T<sub>on</sub> (&#956;s) : 0.633 <BR> T<sub>off</sub> (&#956;s) : 128</small>");
									
							break;
							case 5:
									$("#result1").html("<BR><small>Trail : 5 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 3.16 <BR> T<sub>on</sub> (&#956;s) : 0.760 <BR> T<sub>off</sub> (&#956;s) : 128<small>");
									
							break;
							case 6:
									$("#result1").html("<BR><small>Trail : 6 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 2.75 <BR> T<sub>on</sub> (&#956;s) : 0.888 <BR> T<sub>off</sub> (&#956;s) : 128<small>");
									
							break;
							case 7:
									$("#result1").html("<BR><small>Trail : 7 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 2.71<BR> T<sub>on</sub> (&#956;s) : 1.016 <BR> T<sub>off</sub> (&#956;s) : 128<small>");
									
							break;
							case 8:
									$("#result1").html("<BR><small>Trail : 8 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 2.73 <BR> T<sub>on</sub> (&#956;s) : 1.143 <BR> T<sub>off</sub> (&#956;s) : 128<small>");
									
							break;
							case 9:
									$("#result1").html("<BR><small>Trail : 9 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 2.66 <BR> T<sub>on</sub> (&#956;s) : 1.27 <BR> T<sub>off</sub> (&#956;s) : 128</small>");
									
							break;
							case 10:
									$("#result1").html("<BR><small>Trail : 10 <br>"+"Voltage (V) : 48-50 <BR> Machine Time (min)  : 2.6 <BR> T<sub>on</sub> (&#956;s) : 1.4 <BR> T<sub>off</sub> (&#956;s) : 128</small>");
...
var drawgraph_gr1 = function(){
	...
	setTimeout(function(){
		chart = new Highcharts.Chart(options);
		swfobject.embedSWF("css/images/exp3.swf", "myContent", "572", "219", "9.0.0");
	},1000);	
...
var image = function  () {
	//alert(1);
  swfobject.embedSWF("css/images/exp3.swf", "myContent", "542", "185", "9.0.0");
}
